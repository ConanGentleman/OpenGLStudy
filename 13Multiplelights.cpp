...
"vec3 viewDir = normalize(viewPos - FragPos); //聚光灯（视角）方向\n"
"// phase 1: 定向光\n"
...
int main()
{
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transformLoc = glGetUniformLocation(shaderProgram, "dirLight.direction");
        glUniform3f(transformLoc,  -0.2f, -1.0f, -0.3f);
        transformLoc = glGetUniformLocation(shaderProgram, "dirLight.ambient");
        glUniform3f(transformLoc, 0.05f, 0.05f, 0.05f);
        transformLoc = glGetUniformLocation(shaderProgram, "dirLight.diffuse");
        glUniform3f(transformLoc, 0.4f, 0.4f, 0.4f);
        transformLoc = glGetUniformLocation(shaderProgram, "dirLight.specular");
        glUniform3f(transformLoc, 0.5f, 0.5f, 0.5f);

        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].position");
        glUniform3f(transformLoc, pointLightPositions[0].x, pointLightPositions[0].y, pointLightPositions[0].z);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].ambient");
        glUniform3f(transformLoc, 0.05f, 0.05f, 0.05f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].diffuse");
        glUniform3f(transformLoc, 0.8f, 0.8f, 0.8f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].specular");
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].constant");
        glUniform1f(transformLoc, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].linear");
        glUniform1f(transformLoc, 0.09f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[0].quadratic");
        glUniform1f(transformLoc, 0.032f);

        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].position");
        glUniform3f(transformLoc, pointLightPositions[1].x, pointLightPositions[1].y, pointLightPositions[1].z);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].ambient");
        glUniform3f(transformLoc, 0.05f, 0.05f, 0.05f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].diffuse");
        glUniform3f(transformLoc, 0.8f, 0.8f, 0.8f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].specular");
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].constant");
        glUniform1f(transformLoc, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].linear");
        glUniform1f(transformLoc, 0.09f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[1].quadratic");
        glUniform1f(transformLoc, 0.032f);

        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].position");
        glUniform3f(transformLoc, pointLightPositions[2].x, pointLightPositions[2].y, pointLightPositions[2].z);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].ambient");
        glUniform3f(transformLoc, 0.05f, 0.05f, 0.05f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].diffuse");
        glUniform3f(transformLoc, 0.8f, 0.8f, 0.8f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].specular");
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].constant");
        glUniform1f(transformLoc, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].linear");
        glUniform1f(transformLoc, 0.09f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[2].quadratic");
        glUniform1f(transformLoc, 0.032f);

        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].position");
        glUniform3f(transformLoc, pointLightPositions[3].x, pointLightPositions[3].y, pointLightPositions[3].z);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].ambient");
        glUniform3f(transformLoc, 0.05f, 0.05f, 0.05f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].diffuse");
        glUniform3f(transformLoc, 0.8f, 0.8f, 0.8f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].specular");
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].constant");
        glUniform1f(transformLoc, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].linear");
        glUniform1f(transformLoc, 0.09f);
        transformLoc = glGetUniformLocation(shaderProgram, "pointLights[3].quadratic");
        glUniform1f(transformLoc, 0.032f);
        ...
        //glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.position");
        glUniform3f(transformLoc, camera.Position.x, camera.Position.y, camera.Position.z);//聚光灯位置就是视角
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.direction");
        glUniform3f(transformLoc, camera.Front.x, camera.Front.y, camera.Front.z);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.ambient");
        //glUniform3f(transformLoc, ambientColor.x, ambientColor.y, ambientColor.z);
        glUniform3f(transformLoc, 0.0f, 0.0f, 0.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.diffuse");
        //glUniform3f(transformLoc, diffuseColor.x, diffuseColor.y, diffuseColor.z);
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.specular");
        glUniform3f(transformLoc, 1.0f, 1.0f, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.constant");
        glUniform1f(transformLoc, 1.0f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.linear");
        glUniform1f(transformLoc, 0.09f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.quadratic");
        glUniform1f(transformLoc, 0.032f);
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.cutOff");
        glUniform1f(transformLoc, glm::cos(glm::radians(12.5f)));
        transformLoc = glGetUniformLocation(shaderProgram, "spotLight.outerCutOff");
        glUniform1f(transformLoc, glm::cos(glm::radians(15.0f)));
