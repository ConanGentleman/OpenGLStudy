...
int main()
{
    ...
    // -------------------------
    Shader shader("30.parallax_mapping.vs", "30.parallax_mapping.fs");
   ...
   // --------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(GL_TEXTURE_2D, diffuseMap);//漫反射贴图
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D, normalMap);//法线贴图
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_2D, heightMap);//高度贴图
        renderQuad();
