...
#pragma region MyRegion
    ...
    */
    while (!glfwWindowShouldClose(window))
    {
        ...
        //}
        int mixValueLocation = glGetUniformLocation(shaderProgram, "objectColor");
        if (mixValueLocation != -1) {
            //cout << mixValue << endl;
            glUniform3f(mixValueLocation, 1.0f, 0.5f, 0.31f);
        }
        mixValueLocation = glGetUniformLocation(shaderProgram, "lightColor");
        if (mixValueLocation != -1) {
            //cout << mixValue << endl;
            glUniform3f(mixValueLocation, 1.0f, 1.0f, 1.0f);
        }
        modelmat();
        viewmat();
        projectionmat();
